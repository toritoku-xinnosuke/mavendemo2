...
public class InsertLocalhostDemo {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/cpsp?useUnicode=true&amp;characterEncoding=UTF-8&amp;rewriteBatchedStatements=true";
